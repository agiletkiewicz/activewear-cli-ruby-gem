...
Gem::Specification.new do |spec|
  spec.name          = "ethical_activewear"
  spec.version       = EthicalActivewear::VERSION
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "http://anything.com"
    spec.metadata["changelog_uri"] = "http://anything.com"
  else
